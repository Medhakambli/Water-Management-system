...
class Check:
    def __init__(self, master):
        ...
        self.lblTitle = Label(self.frame, text='Home Page', font=('arial', 50, 'bold'), bg='powder blue',
                              fg='black')  # Create a label for the title
        self.lblTitle.grid(row=0, column=0, columnspan=2, pady=40)  # Place the label in the frame

        ###~~~Buttons~~~###
        self.LoginFrame = LabelFrame(self.frame, width=1000, height=600, font=('arial', 20, 'bold'), relief='ridge',
                                     bg='cadet blue', bd=20)  # Create a labeled frame
        self.LoginFrame.grid(row=2, column=0)  # Place the labeled frame in the frame

        self.btnCustomer = Button(self.LoginFrame, text='Customer', width=17, font=('arial', 20, 'bold'),
                                  command=self.CustomerLogin)  # Create a button for customer login
        self.btnCustomer.grid(row=1, column=1, pady=20, padx=8)  # Place the button in the labeled frame

        self.btnAdmin = Button(self.LoginFrame, text='Admin', width=17, font=('arial', 20, 'bold'),
                               command=self.AdminLogin)  # Create a button for admin login
        self.btnAdmin.grid(row=2, column=1, pady=20, padx=8)  # Place the button in the labeled frame

        self.btnOfficer = Button(self.LoginFrame, text='Officer', width=17, font=('arial', 20, 'bold'),
                                 command=self.OfficerLogin)  # Create a button for officer login
    ...
    def AdminLogin(self):
        ...
        self.app = Window1(
            self.newWindow)  # Create an instance of the Window1 class. i.e., Redirect to Admin's Login Page

    ###~~~Customer Login Redirect~~~###
    def CustomerLogin(self):
        self.newWindow = Toplevel(self.master)  # Create a new top-level window
        self.app = Window2(
            self.newWindow)  # Create an instance of the Window2 class. i.e., Redirect to Customer's Login Page

    ###~~~Officer Login Redirect~~~###
    def OfficerLogin(self):
        self.newWindow = Toplevel(self.master)  # Create a new top-level window
        self.app = Window3(
            self.newWindow)  # Create an instance of the Window3 class. i.e., Redirect to Officer's Login Page
...
class Window1:
    def __init__(self, master):
        ...
        ###~~~Window1 Title~~~###
        self.lblTitle = Label(self.frame, text='Admin Login Page', font=('arial', 50, 'bold'), bg='powder blue',
                              fg='black')
        ...
        ###~~~Window1 Labels~~~###
        self.lblUsername = Label(self.LoginFrame1, text='Username', font=('arial', 20, 'bold'), bd=22, bg='cadet blue',
                                 fg='Cornsilk')
        ...
        self.lblPassword = Label(self.LoginFrame1, text='Password', font=('arial', 20, 'bold'), bd=22, bg='cadet blue',
                                 fg='Cornsilk')
        ...
        self.btnCustomer = Button(self.Loginframe3, text='Customer', state=DISABLED, width=12,
                                  font=('arial', 20, 'bold'), command=self.Customer)
        self.btnCustomer.grid(row=0, column=0)

        self.btnOfficer = Button(self.Loginframe3, text='Officer', state=DISABLED, width=12, font=('arial', 20, 'bold'),
                                 command=self.Officer)
        self.btnOfficer.grid(row=0, column=1, pady=0, padx=20)

        self.btnBills = Button(self.Loginframe3, text='Bills', state=DISABLED, width=12, font=('arial', 20, 'bold'),
                               command=self.Bills)
        self.btnBills.grid(row=0, column=2, pady=0, padx=20)

        self.btnLocality = Button(self.Loginframe3, text='Locality', state=DISABLED, width=12,
                                  font=('arial', 20, 'bold'), command=self.Locality)
        self.btnLocality.grid(row=0, column=3, pady=0, padx=20)

        self.btnReservoir = Button(self.Loginframe3, text='Reservoir', state=DISABLED, width=12,
                                   font=('arial', 20, 'bold'), command=self.Reservoir)
    ...
    def Login_System(self):
        ...
        if (u == str('Kevin') and p == str(
                'Owens')):  # The Username is set to : "Kevin" and the Password is set to : "Owens"
            ...
            tkinter.messagebox.askyesno("Error",
                                        "The entered details are wrong")  # Show an error message box if wrong credentials are entered
...
class Customer:
    ...
    def __init__(self, root):
        ...
        def update():
            ...
            if (len(id.get()) != 0):
                backend.addCustomer(id.get(), Name.get(), Address.get(), sector_no.get(), officer_id.get(),
                                    reservoir_id.get(), no_of_connection.get())
        ...
        self.btnAddNew = Button(ButtonFrame, pady=1, bd=4, font=('arial', 20, 'bold'), text="Insert New", padx=24,
                                width=8, height=1, command=addData).grid(row=0, column=0, padx=1)

        # Button for displaying data
        self.btnDisplay = Button(ButtonFrame, pady=1, bd=4, font=('arial', 20, 'bold'), text="Display", padx=24,
                                 width=8, height=1, command=displayData).grid(row=0, column=1, padx=1)

        # Button for deleting data
        self.btnDelete = Button(ButtonFrame, pady=1, bd=4, font=('arial', 20, 'bold'), text="Delete", padx=24, width=8,
                                height=1, command=deleteData).grid(row=0, column=2, padx=1)

        # Button for updating data
        self.btnUpdate = Button(ButtonFrame, pady=1, bd=4, font=('arial', 20, 'bold'), text="Update", padx=24, width=8,
                                height=1, command=update).grid(row=0, column=3, padx=1)

        # Button for resetting data
        self.btnReset = Button(ButtonFrame, pady=1, bd=4, font=('arial', 20, 'bold'), text="Reset", padx=24, width=8,
                               height=1, command=iReset).grid(row=0, column=4, padx=1)

        # Button for exiting the application
        self.btnExit = Button(ButtonFrame, pady=1, bd=4, font=('arial', 20, 'bold'), text="Exit", padx=24, width=8,
                              height=1, command=iExit).grid(row=0, column=5, padx=1)
        ...
        self.lblName = Label(WidgetFrame, font=('arial', 12, 'bold'), text='Customer Name ', bd=7, anchor='w',
                             justify=LEFT)
        ...
        self.lblAddress = Label(WidgetFrame, font=('arial', 12, 'bold'), text='Address ', bd=7, anchor='w',
                                justify=LEFT)
        self.lblAddress.grid(row=2, column=0, sticky=W, padx=5)
        self.txtAddress = Entry(WidgetFrame, font=('arial', 12, 'bold'), bd=5, width=40, justify="left",
                                textvariable=Address)
        self.txtAddress.grid(row=2, column=1)

        # Creating label and grid for Sector Number
        self.lblsector_no = Label(WidgetFrame, font=('arial', 12, 'bold'), text='Sector No ', bd=7, anchor='w',
                                  justify=LEFT)
        self.lblsector_no.grid(row=3, column=0, sticky=W, padx=5)
        self.cbosector_no = ttk.Combobox(WidgetFrame, width=39, font=('arial', 12, 'bold'), state='readonly',
                                         textvariable=sector_no)
        ...
        self.lblofficer_id = Label(WidgetFrame, font=('arial', 12, 'bold'), text='Officer ID', bd=7, anchor='w',
                                   justify=LEFT)
        self.lblofficer_id.grid(row=4, column=0, sticky=W, padx=5)
        self.txtofficer_id = Entry(WidgetFrame, font=('arial', 12, 'bold'), bd=5, width=40, justify="left",
                                   textvariable=officer_id)
        self.txtofficer_id.grid(row=4, column=1)

        # Creating label and grid for Reservoir ID
        self.lblreservoir_id = Label(WidgetFrame, font=('arial', 12, 'bold'), text='Reservoir ID', bd=7, anchor='w',
                                     justify=LEFT)
        self.lblreservoir_id.grid(row=5, column=0, sticky=W, padx=5)
        self.txtreservoir_id = Entry(WidgetFrame, font=('arial', 12, 'bold'), bd=5, width=40, justify="left",
                                     textvariable=reservoir_id)
        self.txtreservoir_id.grid(row=5, column=1)

        # Creating label and grid for Number of Connections
        self.lblno_of_connection = Label(WidgetFrame, font=('arial', 12, 'bold'), text='No. of connections', bd=7,
                                         anchor='w', justify=LEFT)
        self.lblno_of_connection.grid(row=6, column=0, sticky=W, padx=5)
        self.txtno_of_connection = Entry(WidgetFrame, font=('arial', 12, 'bold'), bd=5, width=40, justify="left",
                                         textvariable=no_of_connection)
        ...
        self.customerlist = ttk.Treeview(TreeViewFrame, height=12, columns=(
        "id", "Name", "Address", "sector_no", "officer_id", "reservoir_id", "no_of_connection"),
...
class Officer:
    ...
    def __init__(self, root):
        ...
        self.lblName = Label(WidgetFrame, font=('arial', 12, 'bold'), text='Officer Name ', bd=7, anchor='w',
                             justify=LEFT)
        self.lblName.grid(row=1, column=0, sticky=W, padx=5)
        self.txtName = Entry(WidgetFrame, font=('arial', 12, 'bold'), bd=5, width=40, justify="left", textvariable=Name)
        self.txtName.grid(row=1, column=1)
        ...
        self.officerlist = ttk.Treeview(TreeViewFrame, height=12, columns=("id", "Name", "sector_no"),
                                        xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)
...
class Bills:
    ...
    def __init__(self, root):
        ...
        self.lblcustomer_id = Label(WidgetFrame, font=('arial', 12, 'bold'), text='Customer ID ', bd=7, anchor='w',
                                    justify=LEFT)
        self.lblcustomer_id.grid(row=1, column=0, sticky=W, padx=5)
        self.txtcustomer_id = Entry(WidgetFrame, font=('arial', 12, 'bold'), bd=5, width=40, justify="left",
                                    textvariable=customer_id)
        self.txtcustomer_id.grid(row=1, column=1)

        self.lblPayments_Due = Label(WidgetFrame, font=('arial', 12, 'bold'), text='Payment Due ', bd=7, anchor='w',
                                     justify=LEFT)
        self.lblPayments_Due.grid(row=2, column=0, sticky=W, padx=5)
        self.txtPayments_Due = Entry(WidgetFrame, font=('arial', 12, 'bold'), bd=5, width=40, justify="left",
                                     textvariable=Payments_Due)
        self.txtPayments_Due.grid(row=2, column=1)

        self.lbldue_Date = Label(WidgetFrame, font=('arial', 12, 'bold'), text='Due Date', bd=7, anchor='w',
                                 justify=LEFT)
        self.lbldue_Date.grid(row=3, column=0, sticky=W, padx=5)
        self.txtdue_Date = Entry(WidgetFrame, font=('arial', 12, 'bold'), bd=5, width=40, justify="left",
        ...
        self.billinglist = ttk.Treeview(TreeViewFrame, height=12,
                                        columns=("id", "customer_id", "Payments_Due", "due_Date"),
                                        xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)
...
class Locality:
    ...
    def __init__(self, root):
        ...
        def update():
            ...
            if (len(sector_no.get()) != 0):
                backend.addLocality(sector_no.get(), Area_Name.get(), Water_Supply_Date.get(), officer_id.get(),
                                    reservoir_id.get())
        ...
        self.lblArea_Name = Label(WidgetFrame, font=('arial', 12, 'bold'), text='Area Name ', bd=7, anchor='w',
                                  justify=LEFT)
        ...
        self.txtArea_Name = Entry(WidgetFrame, font=('arial', 12, 'bold'), bd=5, width=40, justify="left",
        ...
        self.lblWater_Supply_Date = Label(WidgetFrame, font=('arial', 12, 'bold'), text='Water Supply Date ', bd=7,
                                          anchor='w', justify=LEFT)
        ...
        self.txtWater_Supply_Date = Entry(WidgetFrame, font=('arial', 12, 'bold'), bd=5, width=40, justify="left",
                                          textvariable=Water_Supply_Date)
        ...
        self.localitylist = ttk.Treeview(TreeViewFrame, height=12, columns=(
        "sector_no", "Area_Name", "Water_Supply_Date", "officer_id", "reservoir_id"), xscrollcommand=scroll_x.set,
    ...
    def __init__(self, root):
        ...
        def deleteData():
            ...
            if (len(id.get()) != 0):
                ...
                tkinter.messagebox.showinfo("Delete",
                                            "Record successfully deleted")  # Show a messagebox to indicate that the record was deleted successfully
        ...
        def update():
            ...
            if (len(id.get()) != 0):
                backend.addReservoir(id.get(), Name.get(),
                                     Water_level.get())  # Add the updated data to the reservoir database
        ...
        self.lblid = Label(WidgetFrame, font=('arial', 12, 'bold'), text='Reservoir ID ', bd=7, anchor='w',
                           justify=LEFT)
        self.lblid.grid(row=0, column=0, sticky=W, padx=5)
        self.txtid = Entry(WidgetFrame, font=('arial', 12, 'bold'), bd=5, width=40, justify="left", textvariable=id)
        self.txtid.grid(row=0, column=1)

        self.lblName = Label(WidgetFrame, font=('arial', 12, 'bold'), text='Reservoir Name ', bd=7, anchor='w',
                             justify=LEFT)
        self.lblName.grid(row=1, column=0, sticky=W, padx=5)
        self.txtName = Entry(WidgetFrame, font=('arial', 12, 'bold'), bd=5, width=40, justify="left", textvariable=Name)
        self.txtName.grid(row=1, column=1)

        self.lblWater_level = Label(WidgetFrame, font=('arial', 12, 'bold'), text='Water Level ', bd=7, anchor='w',
                                    justify=LEFT)
        self.lblWater_level.grid(row=2, column=0, sticky=W, padx=5)
        self.txtWater_level = Entry(WidgetFrame, font=('arial', 12, 'bold'), bd=5, width=40, justify="left",
                                    textvariable=Water_level)
        ...
        self.reservoirlist = ttk.Treeview(TreeViewFrame, height=12, columns=("id", "Name", "Water_level"),
                                          xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)
        ...
        self.reservoirlist.bind("<ButtonRelease-1>",
                                ReservoirREC)  # Binding a function to the treeview's button release event
...
class Window2:
    def __init__(self, root):
        ...
        self.l2 = Label(TopFrame1, font=('arial', 20, 'bold'), textvariable=my_str1, width=30, fg='purple', bd=7,
        ...
        self.l3 = Label(TopFrame1, font=('arial', 20, 'bold'), textvariable=my_str2, width=30, fg='purple', bd=7,
                        anchor='center', relief=RIDGE)
        ...
        self.l4 = Label(TopFrame1, font=('arial', 20, 'bold'), textvariable=my_str3, width=30, fg='purple', bd=7,
                        anchor='center', relief=RIDGE)
        ...
        self.l5 = Label(TopFrame1, font=('arial', 20, 'bold'), textvariable=my_str4, width=30, fg='purple', bd=7,
                        anchor='center', relief=RIDGE)
        ...
        self.l6 = Label(TopFrame1, font=('arial', 20, 'bold'), textvariable=my_str5, width=30, fg='purple', bd=7,
                        anchor='center', relief=RIDGE)
        self.l6.grid(row=7, column=2)

        # Label for Reservoir ID
        self.demo_l7 = Label(TopFrame1, font=('arial', 20, 'bold'), text='Reservoir ID', width=20, bd=7,
                             anchor='center')
        self.demo_l7.grid(row=8, column=1, padx=10)
        self.l7 = Label(TopFrame1, font=('arial', 20, 'bold'), textvariable=my_str6, width=30, fg='purple', bd=7,
                        anchor='center', relief=RIDGE)
        self.l7.grid(row=8, column=2)

        # Label for No. of Connections
        self.demo_l8 = Label(TopFrame1, font=('arial', 20, 'bold'), text='No. of Connections', width=20, bd=7,
                             anchor='center')
        self.demo_l8.grid(row=9, column=1, padx=10)
        self.l8 = Label(TopFrame1, font=('arial', 20, 'bold'), textvariable=my_str7, width=30, fg='purple', bd=7,
                        anchor='center', relief=RIDGE)
        self.l8.grid(row=9, column=2)

        # Label for Water Supply Date
        self.demo_l9 = Label(TopFrame1, font=('arial', 20, 'bold'), text='Water Supply Date', width=20, bd=7,
                             anchor='center')
        self.demo_l9.grid(row=10, column=1, padx=10)
        self.l9 = Label(TopFrame1, font=('arial', 20, 'bold'), textvariable=my_str8, width=30, fg='purple', bd=7,
                        anchor='center', relief=RIDGE)
        ...
        self.l10 = Label(TopFrame1, font=('arial', 20, 'bold'), textvariable=my_str9, width=30, fg='purple', bd=7,
                         anchor='center', relief=RIDGE)
        ...
        self.btn = Button(ButtonFrame, pady=1, bd=4, font=('arial', 20, 'bold'), text="Show Details", padx=24, width=8,
                          height=1, command=lambda: my_details(self.t1.get('1.0', END))).grid(row=0, column=0, padx=1)
...
class Window3:
    def __init__(self, root):
        ...
        self.btnDisplay = Button(ButtonFrame, pady=1, bd=4, font=('arial', 20, 'bold'), text="Get Details", padx=24,
                                 width=8, height=1, command=displayData).grid(row=0, column=0, padx=1)

        ###~~~Officer Login Label~~~###

        # Create a label for entering the Officer ID
        self.lblofficer_id = Label(LabelFrame, font=('arial', 20, 'bold'), text='Enter Officer ID:', width=15, height=1,
                                   pady=1, bd=4, )
        self.lblofficer_id.grid(row=1, column=1)

        # Create an entry field for the Officer ID
        self.txtofficer_id = Entry(LabelFrame, font=('arial', 20, 'bold'), width=10, bg='white', bd=5,
                                   textvariable=officer_id)
        ...
        self.OfficerCustomerList = ttk.Treeview(TreeViewFrame, height=12, columns=(
        "id", "Name", "Address", "sector_no", "officer_id", "reservoir_id", "no_of_connection"),
                                                xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)
